...
urlpatterns = [
    ...
    path('product/remove_from_cart/<int:pk>',
         remove_product_from_cart, name='product_remove_form_cart'),
    path('product/buy_products', buy_products_from_cart,
         name='buy_products_from_cart'),
    path('product/shopping_history', HistoryListView.as_view(),
         name='shopping_history_list'),

    # Publicity
    path('publicity/create', PublicityCreateView.as_view(), name='publicity_create'),
    path('publicity/change/<int:pk>',
         PublicityUpdateView.as_view(), name='publicity_update'),
    path('publicity/delete/<int:pk>',
         PublicityDeleteView.as_view(), name='publicity_delete'),
